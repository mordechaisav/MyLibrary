...
namespace MyLibrary.Controllers
{
    public class ShelvesController : Controller
    {
        ...
        {
            var otzarContext = _context.Shelf.Include(s => s.Library);
        ...
        public async Task<IActionResult> Create([Bind("Id,LibraryId,Width,Height,Space")] Shelf shelf)
        {
            ModelState.Remove("Library");
            if (ModelState.IsValid)
            {
                shelf.Space = shelf.Width;
                _context.Add(shelf);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,LibraryId,Width,Height,Space")] Shelf shelf)
        {
            if (id != shelf.Id)
            {
                return NotFound();
